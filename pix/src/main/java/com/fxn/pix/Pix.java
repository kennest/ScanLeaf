...
public class Pix extends AppCompatActivity implements View.OnTouchListener {
    ...
    public static void start(Fragment context, int requestCode) {
        start(context, Options.init().setRequestCode(requestCode).setCount(5));
    }
    ...
    private void initialize() {
        ...
        devant= R.drawable.ic_photo_devant;
                    ...
                    public Unit invoke(Bitmap bitmap) {
                        if (bitmap != null) {
                            ...
                            synchronized (bitmap) {
                                ...
                                Toast.makeText(Pix.this, "Photo sauvé avec comme chemin d'accès: "+photo.getAbsolutePath()+" ! ☻", Toast.LENGTH_LONG).show();
        ...
        front.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                oa1.addListener(new AnimatorListenerAdapter() {
                    ...
                    public void onAnimationEnd(Animator animation) {
                        super.onAnimationEnd(animation);
                        if (devant==R.drawable.ic_photo_devant){
                            devant = R.drawable.ic_photo_camera;
                            front.setImageResource(devant);
    ...
    private void updateImages() {
        ...
        ArrayList<Img> CULTURELIST = new ArrayList<>();
//        CULTURELIST.add();
//        CULTURELIST.add(getResources().getDrawable(R.drawable.mais_cult));
//        CULTURELIST.add(getResources().getDrawable(R.drawable.orange_cult));
//        CULTURELIST.add(getResources().getDrawable(R.drawable.pomme_cult));
//        CULTURELIST.add(getResources().getDrawable(R.drawable.riz_cult));
//        CULTURELIST.add(getResources().getDrawable(R.drawable.tomate_cult));
